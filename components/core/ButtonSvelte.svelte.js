import './ButtonSvelte.svelte.css.proxy.js';
/* components/core/ButtonSvelte.svelte generated by Svelte v3.32.2 */
import {
	SvelteComponent,
	append,
	attr,
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			t0 = text("Svelte Button (Local Counter: ");
			t1 = text(/*localCounter*/ ctx[2]);
			t2 = text(" / Shared Counter: ");
...
class ButtonSvelte extends SvelteComponent {
	constructor(options) {
		super();
